...
export const Primary: Story = {
  args: {
    ...
    main: '뷰 선택하기',
    children: [
      <Filter.FilterOption id="a" name="a" onChange={e => console.log(e.target.value)} value="a" checked>
        a
      </Filter.FilterOption>,
      <Filter.FilterOption id="b" name="b" onChange={e => console.log(e.target.value)} value="b" checked>
        b
      </Filter.FilterOption>,
      <Filter.FilterOption id="c" name="c" onChange={e => console.log(e.target.value)} value="c" checked={false}>
        c
      </Filter.FilterOption>,
    ],
  },
