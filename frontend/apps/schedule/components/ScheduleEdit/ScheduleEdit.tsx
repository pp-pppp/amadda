...
export function ScheduleEdit({ scheduleDetail }: ScheduleEditFormProps) {
  const scheduleSubmit = useScheduleSubmit();
  const data = useForm<ScheduleEditFormData>(['scheduleEdit', scheduleDetail || initFormValues, scheduleSubmit, scheduleFormValidator, refInputNames]);
